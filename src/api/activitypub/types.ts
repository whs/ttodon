...
export interface ASObject<Type = string> {
	'@context'?:
		...
		| ['https://www.w3.org/ns/activitystreams']
		| ['https://www.w3.org/ns/activitystreams', Record<string, any>];
	id?: string;
	type?: Type;
 ...
 */
export interface Collection<ItemType = string, T = 'Collection'>
	extends ASObject<T> {
...
export interface OrderedCollection<ItemType = string>
	extends Collection<ItemType, 'OrderedCollection'> {}

export interface CollectionPage<ItemType = string>
	extends Collection<ItemType, 'CollectionPage'> {
...
export interface IntransitiveActivity<
	...
	OriginType = string,
	InstrumentType = string,
	ActivityType = 'IntransitiveActivity',
> extends Omit<
		Activity<
			ActorType,
			ObjectType,
